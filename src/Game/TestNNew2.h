...
void CharacterEntity::CheckCollision()
{
	...
	// на случай пролета объектов через объект (обычно юзают Continuous Collision Detection) - разбивать движение на итерации с фиксированным рассто€нием и циклом каждое проверить - например шаг 0.1, персонаж сдвинулс€ с 8 до 9, значит не двигать по формуле pos + velocity, где Velocity равно 1. а разделить на дес€ть итераций со сдвигом в 0.1 и в каждую провер€ть столкновение. ¬роде называетс€ Supersampling
