...
#define GJK_MAX_ITERATIONS 20
	...
	FrustumOld FrustumBuild(const glm::mat4& projview);
	int     FrustumTestSphere(const FrustumOld& f, const Sphere& s);
	int     FrustumTestAABB(const FrustumOld& f, const AABB& a);
