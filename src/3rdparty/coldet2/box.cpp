...
namespace coldet
{
	...
	bool Box::intersect(const Vector3D& O, const Vector3D& D, float segmax)
	{
	...
	bool Triangle::intersect(const Vector3D& O, const Vector3D& D, Vector3D& cp, float& tparm, float segmax)
	{
		Plane p(v1, v2, v3);
